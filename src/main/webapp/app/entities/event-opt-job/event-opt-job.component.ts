...
@Component({
    selector: 'jhi-event-opt-job',
    templateUrl: './event-opt-job.component.html'
})
export class EventOptJobComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.eventService.query({
            ...
            (res: HttpResponse<EventOptJob[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: EventOptJob) {
        return item.id;
    }
