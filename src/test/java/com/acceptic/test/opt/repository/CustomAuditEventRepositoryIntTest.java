...
import com.acceptic.test.opt.config.audit.AuditEventConverter;
import com.acceptic.test.opt.domain.PersistentAuditEvent;
...
import static com.acceptic.test.opt.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
