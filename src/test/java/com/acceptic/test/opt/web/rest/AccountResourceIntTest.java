...
import com.acceptic.test.opt.config.Constants;
import com.acceptic.test.opt.OptimizationJobApp;
import com.acceptic.test.opt.domain.Authority;
import com.acceptic.test.opt.domain.User;
import com.acceptic.test.opt.repository.AuthorityRepository;
import com.acceptic.test.opt.repository.UserRepository;
import com.acceptic.test.opt.security.AuthoritiesConstants;
import com.acceptic.test.opt.service.MailService;
import com.acceptic.test.opt.service.dto.UserDTO;
import com.acceptic.test.opt.web.rest.errors.ExceptionTranslator;
import com.acceptic.test.opt.web.rest.vm.KeyAndPasswordVM;
import com.acceptic.test.opt.web.rest.vm.ManagedUserVM;
import com.acceptic.test.opt.service.UserService;
