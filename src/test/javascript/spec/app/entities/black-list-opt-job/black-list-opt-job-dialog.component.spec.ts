...
import { BlackListOptJobDialogComponent } from '../../../../../../main/webapp/app/entities/black-list-opt-job/black-list-opt-job-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('BlackListOptJob Management Dialog Component', () => {
        let comp: BlackListOptJobDialogComponent;
        let fixture: ComponentFixture<BlackListOptJobDialogComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [BlackListOptJobDialogComponent],
                providers: [
                    BlackListOptJobService
                ]
            })
            .overrideTemplate(BlackListOptJobDialogComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(BlackListOptJobDialogComponent);
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new BlackListOptJob(123);
            ...
            it('Should call create service on save for new entity',
                inject([],
                    fakeAsync(() => {
                        // GIVEN
                        const entity = new BlackListOptJob();
