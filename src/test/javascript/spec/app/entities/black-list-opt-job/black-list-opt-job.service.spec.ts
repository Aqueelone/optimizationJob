...
describe('Service Tests', () => {
    ...
    describe('BlackListOptJob Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(BlackListOptJobService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/black-lists';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BlackListOptJob', () => {
