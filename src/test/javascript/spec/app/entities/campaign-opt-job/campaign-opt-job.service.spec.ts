...
describe('Service Tests', () => {
    ...
    describe('CampaignOptJob Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampaignOptJobService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campaigns';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CampaignOptJob', () => {
