...
describe('Service Tests', () => {
    ...
    describe('CampaignRecordOptJob Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CampaignRecordOptJobService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/campaign-records';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CampaignRecordOptJob', () => {
