...
describe('Service Tests', () => {
    ...
    describe('PublisherOptJob Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PublisherOptJobService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/publishers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PublisherOptJob', () => {
